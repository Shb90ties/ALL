...
public class Q_collection implements Serializable
{
    ...
    public Question get_random_question_and_delete()
    {
        Random rand = new Random();
        int i = rand.nextInt(this.collection.length);
        Question temp = collection[i];
        remove_question(i);
        return temp;
    }
