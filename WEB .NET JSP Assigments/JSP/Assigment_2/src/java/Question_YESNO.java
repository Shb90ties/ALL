...
@WebServlet(urlPatterns = {"/Question_YESNO"})
public class Question_YESNO extends Game {
            ...
            throws ServletException, IOException 
    {
        ...
        out.println("<div style=\"width: 80%; float: right; text-align: center; height: 900px;\">");
            ...
            out.println("<div style=\"width: 50%; float: left; text-align: center; height: 900px;\">");
                out.println("<input type=\"hidden\" name=\"idd\" value=\"Question_YESNO\">");
            ...
            out.println("<div style=\"width: 50%; float: right; text-align: center; height: 900px;\">"); 
                    ...
                    out.println("<input type=\"radio\" name=\"answer\" value=\"yes\"> - Yes<br>");
                        out.println("<input type=\"radio\" name=\"answer\" value=\"no\"> - No<br>");
            out.println("</div>");
            out.println("</form>");
        out.println("</div>");
